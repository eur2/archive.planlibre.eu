...
<Front>
  {#if randomPost && randomPost.acf.image}
    ...
    <img
      ...
      srcset="{randomPost.acf.image.sizes.thumbnail} 400w, {randomPost.acf.image
        .sizes.medium} 800w, {randomPost.acf.image.sizes.large} 1600w"
      width="800"
      height="600"
        ...
        {#if post.acf.image}
          <div class="p flex jc-center flex50">
            ...
            <img
              ...
              srcset="{post.acf.image.sizes.thumbnail} 400w, {post.acf.image
                .sizes.medium} 800w, {post.acf.image.sizes.large} 1600w"
              alt="plan libre"
            />
          </div>
        {/if}
